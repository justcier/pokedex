...
abstract class $SearchStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({SearchStateStatus status, PokemonDetails? pokemonDetails});
...
class _$_SearchState extends _SearchState {
  const _$_SearchState({required this.status, this.pokemonDetails}) : super._();
  ...
  @override
  String toString() {
    return 'SearchState(status: $status, pokemonDetails: $pokemonDetails)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, status, pokemonDetails);
...
abstract class _SearchState extends SearchState {
  const factory _SearchState(
      ...
      final PokemonDetails? pokemonDetails}) = _$_SearchState;
