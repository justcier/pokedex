...
_i1.GetIt $initGetIt(
  ...
  gh.factoryAsync<_i10.SharedPreferences>(() => registerService.prefs);
  gh.factoryAsync<_i11.PokemonListLocalDataSource>(() async =>
      _i12.PokemonListLocalDataSourceImpl(
          await get.getAsync<_i10.SharedPreferences>()));
  gh.factoryAsync<_i13.PokemonListRepository>(
      () async => _i14.PokemonListRepositoryImpl(
            pokemonListRemoteDataSource: get<_i8.PokemonListRemoteDataSource>(),
            pokemonListLocalDataSource:
                await get.getAsync<_i11.PokemonListLocalDataSource>(),
          ));
  gh.factoryAsync<_i15.GetPokemonDetailsUseCase>(() async =>
      _i15.GetPokemonDetailsUseCase(
          await get.getAsync<_i13.PokemonListRepository>()));
  return get;
}

class _$InjectionRegistrationService
    extends _i16.InjectionRegistrationService {}

class _$RegisterService extends _i17.RegisterService {}
